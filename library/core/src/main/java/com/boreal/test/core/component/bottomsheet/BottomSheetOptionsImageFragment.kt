...
import com.boreal.test.core.databinding.BottomSheetOptionsImageBinding
import com.boreal.test.core.utils.getImageBitmap
import com.boreal.test.core.utils.getImageUri
...
class BottomSheetOptionsImageFragment(
    private var imageReturn: (Uri) -> Unit
) : BottomSheetDialogFragment() {

    private var mImageSelectedUri: Uri? = null
    lateinit var mBinding: BottomSheetOptionsImageBinding
    ...
    override fun onCreateView(
        ...
        mBinding = BottomSheetOptionsImageBinding.inflate(layoutInflater)
